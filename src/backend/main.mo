...
actor Main {
    ...
    public func get_weather_with_recommendations(location: Text) : async WeatherResponse {
        ...
        // Use LLM to fetch weather data and generate recommendations
        await get_weather_data_via_llm(location, "city");
    };
    ...
    public func get_weather_by_coordinates(lat: Float, lon: Float) : async WeatherResponse {
        ...
        // Use LLM to fetch weather data by coordinates and generate recommendations
        let coordinates = Float.toText(lat) # "," # Float.toText(lon);
        await get_weather_data_via_llm(coordinates, "coordinates");
    };
